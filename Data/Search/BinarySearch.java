...
public class BinarySearch {
	 public static void main(String[] args) {
	        ...
	        //data must be sorted !
	        //chooses the element in the middle of the array and compares it againts the search value
	        //if the element is greater than the value, search the left half of the array
	        //if the element is smaller than the value, search the right half of the array
